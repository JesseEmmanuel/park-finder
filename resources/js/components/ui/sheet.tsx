  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-popover bg-clip-padding text-sm text-popover-foreground shadow-lg transition duration-300 ease-in-out",
          // Layout & Sizing
          ...
          // Open Animations (Removed the -10 suffix)
          ...
          // Closed Animations (Removed the -10 suffix)
